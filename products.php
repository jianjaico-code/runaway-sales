              ...
              <table class="table table-borderless" id="productsViewProduct" width="100%">
                ...
                <tbody>
                  ...
                  foreach ($products as $product) {
                    $sizesornull = empty($product["PSizes"]) ?  "N/A" : $product["PSizes"];
                    $colorsornull = empty($product["PColors"]) ? "N/A" : $product["PColors"];
                    $quantityorout = $product["PQuantity"] > 0 ? $product["PQuantity"] : "Out of stocked";
                    echo
                      "<tr>
